//
//  RadialMenuSource.swift — GENERATED, DO NOT EDIT
//
...
//
//  Source: Sources/RadialMenu.swift  (1955 lines, EMBED-VERSION 7)
//

enum RadialMenuSource {
    /// Which revision of the component this copy was taken from.
